package za.co.memela.pcmsurlshortening.service;
...
import za.co.memela.pcmsurlshortening.common.IDConverter;
import za.co.memela.pcmsurlshortening.repository.URLRepository;

@Service
public class URLConverterService {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(URLConverterService.class);
